            ...
            <section className="clean-block clean-form dark">
                <div className="container">
                    ...
                    <form style={{borderTopColor: 'var(--bs-emphasis-color)'}}>
                        ...
                        <div className="mb-3"><label className="form-label" for="password">Confrimar Contraseña</label><input className="form-control" type="password" id="password-1" data-bs-theme="light"/></div>
                        ...
                        <div className="justify-content-center align-items-center" style={{display: 'flex', margin: '15px 0'}}><Link className="txt2" to="/iniciar-sesion/">Ya tienes una cuenta? Inicia Sesion.</Link></div>
