            ...
            <section className="clean-block clean-form dark">
                <div className="container">
                    ...
                    <form style={{borderTopColor: 'var(--bs-emphasis-color)'}}>
                        ...
                        <div className="justify-content-center align-items-center" style={{display: 'flex', margin: '15px 0'}}><a className="txt2" href="../login/">Ya tienes una cuenta? Inicia Sesion.</a></div>
